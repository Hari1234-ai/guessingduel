    ...
    <main className="min-h-screen bg-slate-950 text-slate-300 p-6 md:p-12 flex flex-col items-center">
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight uppercase italic">Privacy Policy</h1>
        </div>
        ...
        <div className="bg-slate-900/30 border border-slate-800 p-8 rounded-3xl backdrop-blur-sm space-y-8 leading-relaxed">
          <section>
            ...
            <p>Welcome to Guessing Duel. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you use our application.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-2">
              <li>Providing and maintaining the Guessing Duel game service.</li>
